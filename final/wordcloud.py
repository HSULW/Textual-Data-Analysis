...
IThelps_file = "IThelp_pages.txt"  # 文檔
...
tags = jieba.analyse.extract_tags(text, topK=30) #設置前30個關鍵詞
...
# 製作文字雲
wordcloud = WordCloud(background_color="white", mask=masks, contour_width=3, contour_color='steelblue', font_path= fontpath).generate_from_frequencies(freq)
plt.figure()
